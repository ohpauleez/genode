...
class Process_tree
{
	...
	public:
		...
		:
			...
			_view_handle(_nitpicker.create_view()),
			...
			_frame(0)
		{
			...
			Nitpicker::Rect rect(Nitpicker::Point(_xpos, _ypos),
			                     Nitpicker::Area(_fb_width, _fb_height/2));
		...
		void render()
		{
			...
			Nitpicker::Point offset(0, buf_y);
...
int main(int argc, char **argv)
{
	...
	static Process_tree process_tree((640 - 400)/2, (480 - 400)/2, 400, 400);
